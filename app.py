...
st.markdown(
    '<p class="sub-title">Apni pasandeeda movie chuno, hum aapko milti-julti movies dikhayenge — poster ke saath!</p>',
    unsafe_allow_html=True
)
...
if show_button:
    ...
    # IMPORTANT: no leading whitespace on any line here,
    # warna Streamlit ka Markdown parser isse code-block samajh lega
    # aur HTML render karne ke bajaye plain text dikha dega.
